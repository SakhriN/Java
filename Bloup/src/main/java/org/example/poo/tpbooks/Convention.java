...
public class Convention {
    public static void main(String[] args) {
        Author test1 = new Author(1,"Michel","Sardou");
        Author test2 = new Author(2,"Daft","Punk");
        Author test3 = new Author(3,"Daft2","Punk");

        Publisher tost1 = new Publisher(1,"LaBagarre");
        Publisher tost2 = new Publisher(2,"LaVRAIEBagarre");

        List<Book> bookList = new ArrayList<>();
        bookList.add(new Book(1, "Pourquoi je suis un mauvais chanteur", new Author[]{test1}, tost1, 2012, 69, 29.12F, Book.CoverType.PAPERBACK));
        bookList.add(new Book(2, "L'art de ne pas se dévoiler", new Author[]{test2, test3}, tost2, 2020, 690, 999.12F, Book.CoverType.HARDCOVER));
